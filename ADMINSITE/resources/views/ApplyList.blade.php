            ...
            <div class="col-md-12 p-5">
                ...
                <table id="SelectTable" class="table table-striped table-responsive table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th class="th-sm">Mother Name</th>
                        <th class="th-sm">Division</th>
                        <th class="th-sm">District</th>
                        <th class="th-sm">Upozila</th>
                        <th class="th-sm">Union</th>
                    ...
                    <div id="EditForm" class="d-none w-100">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="email" id="EmailEditId" class="form-control mb-4" placeholder="Enter Email">
                                <input type="text" id="PhoneEditId" class="form-control mb-4" placeholder="Enter Phone">
                                <input type="text" id="NidEditId" class="form-control mb-4" placeholder="Valid Nid">
                                <input type="date" id="DOBEditId" class="form-control mb-4" placeholder="Date of Birth">
                                <input type="text" id="FatherNameEditId" class="form-control mb-4" placeholder="Father Name">
                            </div>
                            <div class="col-lg-6">
                                <input type="email" id="MotherNameEditId" class="form-control mb-4" placeholder="Mother Name">
                                <input type="text" id="DivisionEditId" class="form-control mb-4" placeholder="Enter Division">
                                <input type="text" id="DistrictEditId" class="form-control mb-4" placeholder="Enter District">
                                <input type="text" id="UpozilaEditId" class="form-control mb-4" placeholder="Enter Upozila">
                                <input type="text" id="UnionEditId" class="form-control mb-4" placeholder="Enter Union">
                                <input type="text" id="WardEditId" class="form-control mb-4" placeholder="Enter Ward">
...
@section('script')
    <script type="text/javascript">
                    ...
                    if(response.status==200){
                        ...
                        $.each(jsonData, function (i, item){
                            ...
                            $('<tr>').html(
                                ...
                                "<td>" + jsonData[i].father_name +"</td>" +
                                "<td>" + jsonData[i].mother_name +"</td>" +
                                "<td>" + jsonData[i].division +"</td>" +
                                "<td>" + jsonData[i].district +"</td>" +
                                "<td>" + jsonData[i].upozila +"</td>" +
                                "<td>" + jsonData[i].union +"</td>" +
                                "<td>" + jsonData[i].ward +"</td>" +
                                "<td><a class='' data-id=" + jsonData[i].r_id + " ><i class='fas fa-check edit-btn-color'></i></a></td>" +
            ...
            axios.post('/getApplyDetails',{
                ...
                .then(function (response){
                    if (response.status==200){
                        ...
                        $('#EmailEditId').val(jsonData[0].email);
                        $('#PhoneEditId').val(jsonData[0].phone);
                        $('#NidEditId').val(jsonData[0].nid);
                        $('#DOBEditId').val(jsonData[0].dob);
                        $('#FatherNameEditId').val(jsonData[0].father_name);
                        $('#MotherNameEditId').val(jsonData[0].mother_name);
                        $('#DivisionEditId').val(jsonData[0].division);
                        $('#DistrictEditId').val(jsonData[0].district);
                        $('#UpozilaEditId').val(jsonData[0].upozila);
                        $('#UnionEditId').val(jsonData[0].union);
                        $('#WardEditId').val(jsonData[0].ward);
        ...
        $('#editConfirmBtn').click(function (){
            ...
            let email  = $('#EmailEditId').val();
            let phone = $('#PhoneEditId').val();
            let nid = $('#NidEditId').val();
            let dob = $('#DOBEditId').val();
            let father_name = $('#FatherNameEditId').val();
            let mother_name = $('#MotherNameEditId').val();
            let division = $('#DivisionEditId').val();
            let district = $('#DistrictEditId').val();
            let upozila  = $('#UpozilaEditId').val();
            let union = $('#UnionEditId').val();
            let ward = $('#WardEditId').val();
            let password = $('#PasswordEditId').val();

            ApplyUpdate(r_id,fast_name,last_name,email,phone,nid,dob,father_name,mother_name,division,district,upozila,union,ward,password);
        })

        //Course Update Method
        function ApplyUpdate(r_id,fast_name,last_name,email,phone,nid,dob,father_name,mother_name,division,district,upozila,union,ward,password){
            let EmailRegx=/\S+@\S+\.\S+/;
